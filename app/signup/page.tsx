  ...
  return (
    <main className="page">
      ...
      <section className="hero" style={{ marginBottom: 0 }}>
        <p className="eyebrow">Get started for free</p>
        <h1 style={{ fontSize: "clamp(30px, 5vw, 52px)", marginBottom: 8 }}>
          Join <span>LexEasy</span>
        </h1>
        <p className="sub">Understand any legal document in 30 seconds.</p>
      </section>
      ...
      <div className="card" style={{ maxWidth: 440, marginTop: 32 }}>
        {verifyPrompt ? (
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <h2 style={{ margin: "0 0 8px", fontSize: 20 }}>Almost there!</h2>
          ...
          <>
            ...
            <p style={{ textAlign: "center", marginTop: 20, fontSize: 13, color: "var(--muted)" }}>
              ...
              <Link href="/login" style={{ color: "var(--green-deep)", fontWeight: 600 }}>
                Sign in
              </Link>
            </p>
          </>
